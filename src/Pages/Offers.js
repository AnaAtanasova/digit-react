...
const OfferCard = (props) => {
  ...
  return (
    <Grid item xs={2} sm={3} md={4} key={r.index}>
      <div
        ...
        >
          ...
          >
            <Button color="error" variant="contained">
              <Rating size="small" name="read-only" value={r.score} readOnly />
            </Button>
          </CardActions>
        </Card>
        <Button
